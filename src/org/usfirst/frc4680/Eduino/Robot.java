...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        ...
        chooser.addObject("Cross the Line", new CrossLineAndStop());
        ...
        chooser.addObject("Better Cross the Line", new BetterCrossLineAndStop());
        chooser.addObject("lift arm 1.0 1.0", new MoveArmByTime(1.0, 1.0));
        chooser.addObject("lift arm 0.7 1.0", new MoveArmByTime(0.7, 1.0));
        chooser.addObject("lift arm 0.7 1.5", new MoveArmByTime(0.7, 1.5));
