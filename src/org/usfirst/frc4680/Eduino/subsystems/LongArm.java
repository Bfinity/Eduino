...
public class LongArm extends Subsystem {
    ...
    private final SpeedController longArmMotorVictorSP = RobotMap.longArmLongArmMotorVictorSP;
    private final Encoder longArmEncoder = RobotMap.longArmLongArmEncoder;
