...
public class LongArm extends Subsystem {
    ...
    private final DigitalInput encoderDirectionInput = RobotMap.longArmEncoderDirectionInput;
    private final DigitalOutput encoderDirectionOutput = RobotMap.longArmEncoderDirectionOutput;
    ...
    public void move(double commandSpeed){
    		longArmMotorVictorSP1.set(-commandSpeed);
    		longArmMotorVictorSP2.set(-commandSpeed);
    		longArmMotorVictorSP3.set(-commandSpeed);
    		longArmMotorVictorSP4.set(-commandSpeed);
    		longArmMotorVictorSP5.set(-commandSpeed);
    		longArmMotorVictorSP6.set(-commandSpeed);
    		
    		if(commandSpeed > 0) {
    			encoderDirectionOutput.set(true);
    		} else {
    			encoderDirectionOutput.set(false);
    		}
    }
