...
public class OI {
    ...
    public OI() {
        ...
        switchHeightButton = new JoystickButton(manipulatorStick, 1);
        switchHeightButton.whenPressed(new LongArmPosition(50));
        ...
        SmartDashboard.putData("LongArmUp", new LongArmUp());
        SmartDashboard.putData("LongArmDown", new LongArmDown());
